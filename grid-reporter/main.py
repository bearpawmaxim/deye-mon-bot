...
# Add shared module to path (local dev or Docker)
_local_shared = Path(__file__).parent.parent / "shared" / "python"
_docker_shared = Path("/shared/python")
sys.path.insert(0, str(_local_shared if _local_shared.exists() else _docker_shared))
